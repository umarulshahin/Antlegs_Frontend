              ...
              <Form className="flex flex-col w-full p-10">
                ...
                <div className="flex justify-center  mt-3">
                  <button
                    ...
                    className="text-white py-1 w-full md:w-1/2 cursor-pointer  text-center bg-gradient-to-l from-blue-400 via-cyan-400 to-cyan-200  rounded-full font-semibold text-lg flex justify-center items-center"
                  >
                    {isSubmitting ? (
